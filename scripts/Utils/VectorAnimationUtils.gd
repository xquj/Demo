...
var end_value: Vector2 = Vector2.ONE
var done: bool = false
...
var _origin_start: Vector2 = Vector2.ZERO


func _init(_start: Vector2 = Vector2.ZERO, _end: Vector2 = Vector2.ONE, _duration: int = 500, _ease: EaseType = EaseType.LINEAR) -> void:
	start_value = _start
	end_value = _end
	end_time = _duration
	ease_type = _ease
